...
const subjectItems = [
  { title: 'Physics', image: 'science', href: '/home/ncert-mcq/class-11/physics' },
  { title: 'Chemistry', image: 'science', href: '#' },
  { title: 'Biology', image: 'science', href: '#' },
  { title: 'Mathematics', image: 'mathematics', href: '#' },
  { title: 'Accountancy', image: 'economics', href: '#' },
  { title: 'Business Studies', image: 'economics', href: '#' },
  ...
  return (
    <div className="bg-background min-h-screen">
      <header className="bg-card text-foreground flex items-center p-4 border-b">
        ...
        <h1 className="text-xl font-bold">Class 11</h1>
      </header>
      <main className="p-4">
